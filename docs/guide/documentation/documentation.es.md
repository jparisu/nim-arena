...
| --- | --- | --- |
| **Tutorial** | «soy nuevo — llévame de la mano por algo que funcione» | [Primeros pasos](../../arena/getting-started.md) |
| **Guía práctica** | «tengo un objetivo concreto» | [Enviar un jugador](../../arena/submit-a-player.md) |
| **Referencia** | «¿qué hace exactamente esto?» | [API de jugador](../../arena/player-api.md), [El marcador](../../arena/scoreboard.md) |
