...
| --- | --- | --- |
| **Tutorial** | "I am new — walk me through something that works." | [Getting started](../../arena/getting-started.md) |
| **How-to guide** | "I have a specific goal." | [Submit a player](../../arena/submit-a-player.md) |
| **Reference** | "What exactly does this do?" | [Player API](../../arena/player-api.md), [The scoreboard](../../arena/scoreboard.md) |
