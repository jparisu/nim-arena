...
Try **X-ray mode** on the [web app](advanced/web.md) to see the nim-sum live during a game.

## Where to go next

- [Getting started](getting-started.md) — install and play a game.
- [Player API](upload-a-bot/player-api.md) — turn the strategy above into a player.
