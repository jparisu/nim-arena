...
│   ├── game/               # el manual de referencia de este repositorio
│   └── guide/              # la Guía: Git, GitHub, Python, docs
...
- [API de jugador](../upload-a-bot/player-api.md) — la única interfaz a la que sirve todo esto.
